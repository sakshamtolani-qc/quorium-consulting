...
const Footer: React.FC = () => {
  ...
  const socialLinks = [
    ...
    {
      icon: Twitter,
      href: 'https://x.com/NexoraOfficials',
      label: 'Twitter'
    }
  ];
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        <div className="py-8 sm:py-12">
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6 sm:gap-8 items-center">
            ...
            <div className="text-center md:text-left">
              ...
              >
                © 2024 Nexora Agency. All rights reserved.
              </motion.p>
            </div>
        ...
        <div className="border-t border-white/10 py-4 sm:py-6">
          <div className="flex flex-col md:flex-row justify-between items-center text-center md:text-left">
            ...
            >
             <span className='text-white/60 text-xs sm:text-sm mb-4 md:mb-0'>Made With ❤️ Nexora Agency</span>
            </motion.nav>
          </div>
        </div>
      </div>
